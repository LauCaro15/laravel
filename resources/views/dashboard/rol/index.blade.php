    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <label class="text-muted">¿Seguro que deseas eliminar la categoría seleccionado?</label>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">
                    Cancelar
                </button>
                <form id="formDelete" method="POST" action="{{ route('rol.destroy', 0) }}"
                    data-action="{{ route('rol.destroy', 0) }}">
                    @method('DELETE')
                    @csrf
